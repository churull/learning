		...
		<header id="header" class=" full-header" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.php?pag=home" class="standard-logo" data-dark-logo="images/logo2.png"><img src="images/logo2.png" alt="EduTech Logo"></a>
						<a href="index.php?page=home" class="retina-logo" data-dark-logo="images/logo2.png"><img src="images/logo2.png" alt="EduTech Logo"></a>
					</div><!-- #logo end -->
