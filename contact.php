<?php
	...
	if( ( isset($name) && !empty($name) ) && ( isset($email) && !empty($email) ) && ( isset($user_msg) && !empty($user_msg) ) && ( isset($phone) && !empty($phone) ) ) {
		...
		$to = "kelompok7@gmail.com"; //Programmers email
...
?>
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				<h1>Contact</h1>
				<span>"Reach Out, We're Here to Help!"</span>
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="sidebar col_last nobottommargin">
						...
						<abbr title="Phone Number"><strong>Phone :</strong></abbr> 08123456787<br>
						<abbr title="Email Address"><strong>Email :</strong></abbr>kelompok7@gmail.com
